...
function LoginForm() {
  ...
  return (
    <div className="w-full max-w-md rounded-2xl border border-gray-200/80 bg-white p-8 shadow-sm dark:border-gray-800 dark:bg-gray-900 sm:p-10">
      ...
      {/* Show alert if redirected right after signup */}
      {isRegistered && (
        <div className="mt-4 rounded-xl border border-emerald-200 bg-emerald-50 p-3.5 text-sm font-semibold text-emerald-800 dark:border-emerald-900/60 dark:bg-emerald-950/40 dark:text-emerald-300 flex items-center gap-2">
